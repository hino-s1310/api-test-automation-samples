...
def parse_coverage_xml(xml_path: str) -> dict:
    ...
    try:
        ...
        return {"line_coverage": 0, "branch_coverage": 0, "formatted": "N/A"}
...
def parse_test_results(xml_path: str) -> dict:
    ...
    try:
        ...
        return {"total": 0, "passed": 0, "failed": 0, "skipped": 0, "success_rate": 0}


def generate_summary(
    coverage_file: str = "coverage.xml", test_file: str = "test-results.xml"
):
    """サマリーレポートを生成"""
