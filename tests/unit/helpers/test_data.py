...
class InvalidTestData:
    ...
    def create_non_pdf_file() -> tuple[str, bytes, str]:
        ...
        """
        return ("test_file.txt", b"This is not a PDF file content", "text/plain")
    ...
    def create_invalid_pdf_file() -> tuple[str, bytes, str]:
        ...
        Returns:
            tuple: (filename, content, content_type)
        """
        return ("invalid.pdf", b"This is not a valid PDF content", "application/pdf")
...
class ExpectedResponses:
    ...
    def validate_response_structure(
        cls, data: dict[str, Any], expected_keys: set
    ) -> bool:
        """レスポンス構造の検証
        Args:
            data: レスポンスデータ
